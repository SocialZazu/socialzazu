...
//                                              resource_inputs:[zipcode_id, address_id, city_id, cost_id, misc_id]});
    ...
    var s_medical_id = make_parent_service('Medical Care', timestamp);
//     var s_disability_id = make_parent_service('Disability', timestamp);
    ...
    var s_legalaid_id = make_parent_service('Legal Aid', timestamp);
    ...
    //housing
    var c_shelter_id = make_child_service('Shelters', timestamp, s_housing_id);
    ...
    var c_pantry_id = make_child_service('Pantry', timestamp, s_food_id);
    var c_hotmeals_id = make_child_service('Hot Meals', timestamp, s_food_id);
    ...
    var c_emercash_id = make_child_service('Emergency Cash Assistance', timestamp, s_finaid_id);
    var c_emerrent_id = make_child_service('Emergency Rent Assistance', timestamp, s_finaid_id);
    var c_secdepo_id = make_child_service('Security Deposit Assistance', timestamp, s_finaid_id);

    //medical s_medical_id
    ...
    var c_substance_id = make_child_service('Treatment Center', timestamp, s_medical_id);
    var c_rehab_id = make_child_service('Rehab', timestamp, s_medical_id);
    var c_hiv_id = make_child_service('HIV', timestamp, s_medical_id);

    //health insur
    var c_aca_id = make_child_service('Affordable Care Act Assistance', timestamp, s_health_insurance_id);
    var c_hia_id = make_child_service('Health Insurance Application', timestamp, s_health_insurance_id);
    var c_mmhapp_id = make_child_service('Medicare Medicaid HealthPAC Application', timestamp, s_health_insurance_id);
    ...
    var c_jobproblem_id = make_child_service('Current Employment Concerns', timestamp, s_employment_id);
    ...
    var c_houseleg_id = make_child_service('Housing Legal Assistance', timestamp, s_legalaid_id);
    ...
    var epiphany_id = make_resource(
      ...
      make_location(
        ...
        [make_address(street:"1615 Broderick St",
                      city:"San Francisco",
                      state:"CA",
                      zipcode:"94115",
                      type:"physical",
         ...
         make_address(street:"100 Masonic Avenue",
                      city:"San Francisco",
                      state:"CA",
                      zipcode:"94118",
                      type:"physical",
        ...
        services=make_services(
          null, null, null, null,
          [sf_id], [c_substance_id]
        )
      )
    );

    var hpp_id = Resources.insert(
      {name:'Homeless Prenatal', updated_time:timestamp, name_route:'Homeless-Prenatal',
       locations: [
         {
           ...
           internet_resource:make_internet_resource('http://www.homelessprenatal.org',
    ...
    var sffb_id = Resources.insert(
      {name:'San Francisco Marin Food Bank', updated_time:timestamp, name_route:'San-Francisco-Marin-Food-Bank',
       locations: [
         {
           ...
           internet_resource:make_internet_resource('http://www.sfmfoodbank.org/',
    ...
    var oakehouse_id = Resources.insert(
      {name:'Oakland Elizabeth House', updated_time:timestamp, name_route:'Oakland-Elizabeth-House',
       locations: [
         {
           ...
           internet_resource:make_internet_resource(
    ...
    Services.update({_id:c_substance_id}, {$push:{resources:{$each: [hpp_id, epiphany_id]}}});
